...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public DecomposeLibraryAccessors getDecompose() {
        return laccForDecomposeLibraryAccessors;
    }
    ...
    public static class DecomposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public DecomposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for decompose (com.arkivanov.decompose:decompose)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
                return create("decompose");
        }

            /**
             * Creates a dependency provider for jetbrains (com.arkivanov.decompose:extensions-compose-jetbrains)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getJetbrains() {
                return create("decompose.jetbrains");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: decompose (2.2.0-alpha03)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: extensionsComposeJetbrains (2.1.4-compose-experimental)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getExtensionsComposeJetbrains() { return getVersion("extensionsComposeJetbrains"); }
            ...
            /**
             * Returns the version associated to this alias: kotlinxSerializationJson (1.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        public AndroidxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidx.material (1.10.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("compose"); }
            ...
            /**
             * Returns the version associated to this alias: compose.plugin (1.5.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
